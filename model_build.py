...
#r2_score_cv = cross_val_score(estimator=model, X=X, y=y, cv=10, scoring='r2')
#print(f"Average R2 Score: {r2_score_cv.mean():.3f}")
#print(f"Standard Deviation: {r2_score_cv.std():.3f}")
